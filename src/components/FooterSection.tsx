        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <p className="font-body text-sm leading-relaxed text-background/60">
              Un loc special pentru educație, lectură și comunitate, fundamentat
              pe valori creștine autentice.
            </p>
          </div>

          {/* Quick Links */}
          <div>
            <h3 className="font-display font-bold text-background mb-4">
              Link-uri Rapide
            </h3>
          ...
          <div>
            ...
            <div className="flex gap-3">
              {[
                {
                  social: Facebook,
                  link: "https://www.facebook.com/people/ASLAN-Centru-Educational-Targoviste/61591926699422/",
                },
                ...
                >
                  <item.social className="w-5 h-5 text-background/70" />
                </a>
              ))}
            </div>
          </div>
