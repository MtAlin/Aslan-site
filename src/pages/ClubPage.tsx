...
> = {
  ...
  muzica: {
    ...
    fullDescription:
      "Clubul de Muzică oferă copiilor și tinerilor oportunitatea de a descoperi bucuria muzicii. Sub îndrumarea unor instructori pasionați, participanții învață să cânte la diverse instrumente, să citească partituri și să aprecieze frumusețea muzicii. Muzica dezvoltă disciplina, creativitatea și sensibilitatea emoțională.",
    schedule: "Miercurea, 16:00 - 18:00",
    location: "Class Park Residence, Târgoviște",
    ageGroup: "8-18 ani",
    activities: [
      "Lecții de chitară, pian și percuție",
      "Cor și cântat vocal",
      "Recitaluri și concerte semestriale",
      "Apreciere muzicală și istorie a muzicii",
      "Ensembluri și duete",
    ],
  },
  engleza: {
  ...
  film: {
    ...
    color: "bg-warm-peach",
    fullDescription:
      "Clubul de Film transformă ecranul într-un instrument educațional puternic. Selectăm cu grijă filme care transmit valori pozitive și teme relevante, urmate de discuții ghidate despre lecțiile învățate. Filmele sunt alese pentru a inspira curaj, bunătate, prietenie și responsabilitate.",
    schedule: "Vinerea, 17:00 - 19:30",
    location: "Class Park Residence, Târgoviște",
    ageGroup: "7-18 ani",
    activities: [
      "Vizionări de filme educative și artistice",
      "Discuții ghidate despre valori și teme",
      "Analiză de personaje și poveste",
      "Ateliere de scurt-metraj",
      "Sesiuni tematice lunare",
    ],
  },
  tabere: {
    title: "Tabere Urbane",
    ...
    color: "bg-warm-gold-light",
    fullDescription:
      "Taberele Urbane ale Bibliotecii Aslan sunt experiențe memorabile care combină educația cu distracția. Pe parcursul vacanțelor, organizăm programe zilnice pline de activități creative, jocuri, excursii locale și momente de învățare prin experiență. Taberele creează amintiri frumoase și prietenii durabile.",
    ...
    activities: [
      ...
      "Excursii educative locale",
      "Ateliere de meșteșuguri",
      "Programe tematice săptămânale",
    ],
  },
};
      ...
      <section className="relative h-[50vh] min-h-[400px] flex items-end overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 pb-12">
          ...
          <div className="flex items-center gap-4">
            <div
              className={`w-14 h-14 ${club.color} rounded-2xl flex items-center justify-center`}
            >
